...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AuthAPI' => 'getAuthAPIService',
            'App\\Controller\\CitiesManagment' => 'getCitiesManagmentService',
            'App\\Controller\\FileAPI' => 'getFileAPIService',
            'App\\Controller\\Index' => 'getIndexService',
            'App\\Controller\\StandAPI' => 'getStandAPIService',
            'App\\Controller\\StandManagement' => 'getStandManagementService',
            'App\\Controller\\UserAPI' => 'getUserAPIService',
            'App\\Controller\\UserManagement' => 'getUserManagementService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventListener/OAuthListener.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\OAuthListener')] fn () => ($container->privates['App\\EventListener\\OAuthListener'] ??= new \App\EventListener\OAuthListener()), 'onKernelRequest'], 0);
